...
const transliteration = (inputText) => {
  let rules = [
    { 'pattern': 'Э', 'replace': 'E' }, //Хотфикс бага русской буквы Э, которая не транслитерировалась
    { 'pattern': 'э', 'replace': 'e' }, //Хотфикс бага русской буквы э, которая не транслитерировалась
    { 'pattern': 'ы', 'replace': 'y' }, //Хотфикс бага русской буквы Ы, которая не транслитерировалась
    { 'pattern': 'а', 'replace': 'a' },
    { 'pattern': 'б', 'replace': 'b' },
    { 'pattern': 'в', 'replace': 'v' },
